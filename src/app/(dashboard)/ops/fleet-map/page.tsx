...
export default function FleetMapPage() {
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="flex gap-0 h-[calc(100vh-180px)]">
          <div className="hidden lg:block w-[280px] bg-white border border-gray-200 rounded-xl animate-pulse" />
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex h-[calc(100vh-180px)] gap-0 overflow-hidden rounded-xl border border-gray-200 shadow-sm">
