...
export default function TenantSettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Tenant Settings</h2>
      ...
      <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-6 space-y-4">
        ...
        <div className="text-sm space-y-2">
          <div className="flex justify-between">
            ...
            <span className="text-gray-700 dark:text-gray-300">PostgreSQL (Supabase)</span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-500">Tenant Isolation</span>
            <span className="text-gray-700 dark:text-gray-300">RLS + tenant_id</span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-500">Encryption</span>
            <span className="text-gray-700 dark:text-gray-300">AES-256-GCM (at rest)</span>
          </div>
        </div>
      </div>
