// ============================================================
// Standard API Error Responses — RX Skin
// All BFF routes use these for consistent error shapes.
// ============================================================
...
/**
 * Map any caught error to a standard API response.
 * Handles CW-specific errors gracefully.
 */
export function handleApiError(error: unknown): Response {
  console.error('[API Error]', error)

  if (error instanceof RateLimitError) {
    return apiErrors.rateLimited(Math.ceil(error.retryAfterMs / 1000))
  }
