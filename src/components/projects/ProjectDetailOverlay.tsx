...
export function ProjectDetailOverlay({ projectId, onClose }: ProjectDetailOverlayProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Close button */}
        <div className="sticky top-0 flex items-center justify-between p-4 border-b border-gray-800/50 bg-gray-900/80 backdrop-blur-sm">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-3 pt-2">
                  <div className="bg-gray-800/50 rounded p-2 text-center">
                    ...
                    <p className="text-lg font-semibold text-gray-100">{Math.round(project.budgetHours)}h</p>
                  </div>
                  <div className="bg-gray-800/50 rounded p-2 text-center">
                    <p className="text-xs text-gray-500 mb-1">Actual</p>
                    <p className="text-lg font-semibold text-gray-100">{Math.round(project.actualHours)}h</p>
                  </div>
                </div>
              </div>
                  ...
                  {project.board && (
                    <div className="flex items-center gap-3 text-gray-300">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-100">{project.board}</p>
                      </div>
                    </div>
                  )}
                  {project.billingMethod && (
                    <div className="flex items-center gap-3 text-gray-300">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-100">{project.billingMethod}</p>
                      </div>
                    </div>
                  )}
                </div>
